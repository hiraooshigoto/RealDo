        ...
        gimmicks: [
            {
                ...
                settings: {
                    ...
                    dots: [
                        // 1行目
                        { x: 20, y: 40, size: 32, beat: 1 },
                        { x: 60, y: 40, size: 32, beat: 1 },
                        { x: 80, y: 50, size: 32, beat: 1 },
                        { x: 20, y: 30, size: 32, beat: 2 },
                        
                        // 2行目
                        { x: 60, y: 50, size: 32, beat: 3 },
                        { x: 20, y: 50, size: 32, beat: 4 },
                        { x: 40, y: 60, size: 32, beat: 4 },
                        { x: 80, y: 60, size: 32, beat: 4 },
                        
                        // 3行目
                        { x: 60, y: 60, size: 32, beat: 5 },
                        { x: 80, y: 40, size: 32, beat: 5 },
                        { x: 60, y: 30, size: 32, beat: 6 },
                        { x: 40, y: 30, size: 32, beat: 7 },
                        
                        // 4行目
                        { x: 80, y: 30, size: 32, beat: 8 }
                    ]
                }
            }
        ]
